...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GyraPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "GyraCheats"

UGyraPlatformEmulationSettings::UGyraPlatformEmulationSettings()
{
}

FName UGyraPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UGyraPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UGyraPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UGyraPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UGyraPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UGyraPlatformEmulationSettings::PostInitProperties()
{
...
void UGyraPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UGyraPlatformEmulationSettings::ApplySettings()
{
...
void UGyraPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UGyraPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UGyraPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UGyraPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
