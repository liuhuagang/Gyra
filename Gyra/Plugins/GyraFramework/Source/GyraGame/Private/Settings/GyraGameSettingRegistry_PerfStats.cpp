...
void UGyraGameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, UGyraLocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)EGyraDisplayablePerformanceStat::Count == 15, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::ClientFPS);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::ServerFPS);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::FrameTime);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::IdleTime);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::Ping);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				UGyraSettingValueDiscrete_PerfStat* Setting = NewObject<UGyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EGyraDisplayablePerformanceStat::PacketSize_Outgoing);
