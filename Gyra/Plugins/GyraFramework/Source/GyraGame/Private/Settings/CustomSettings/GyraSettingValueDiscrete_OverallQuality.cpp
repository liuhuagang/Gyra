...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GyraSettingValueDiscrete_OverallQuality)

#define LOCTEXT_NAMESPACE "GyraSettings"

UGyraSettingValueDiscrete_OverallQuality::UGyraSettingValueDiscrete_OverallQuality()
{
}

void UGyraSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();
...
void UGyraSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void UGyraSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void UGyraSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void UGyraSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UGyraSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> UGyraSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 UGyraSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 UGyraSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
