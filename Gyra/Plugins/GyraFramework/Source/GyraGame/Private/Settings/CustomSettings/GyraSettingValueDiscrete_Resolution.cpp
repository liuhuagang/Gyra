...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GyraSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "GyraSettings"

UGyraSettingValueDiscrete_Resolution::UGyraSettingValueDiscrete_Resolution()
{
}

void UGyraSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UGyraSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UGyraSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UGyraSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UGyraSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UGyraSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UGyraSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UGyraSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UGyraSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UGyraSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UGyraSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UGyraSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UGyraSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UGyraSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{
	int32 Index = 0;
...
void UGyraSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UGyraSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
