...
#include "GyraBrightnessEditor.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GyraBrightnessEditor)
...
UGyraBrightnessEditor::UGyraBrightnessEditor(const FObjectInitializer& Initializer)
	: Super(Initializer)
{
...
void UGyraBrightnessEditor::NativeOnInitialized()
{
	Super::NativeOnInitialized();
	Switcher_SafeZoneMessage->SetActiveWidget(RichText_Default);
}

void UGyraBrightnessEditor::NativeOnActivated()
{
...
bool UGyraBrightnessEditor::ExecuteActionForSetting_Implementation(FGameplayTag ActionTag, UGameSetting* InSetting)
{
...
FReply UGyraBrightnessEditor::NativeOnAnalogValueChanged(const FGeometry& InGeometry, const FAnalogInputEvent& InAnalogEvent)
{
...
FReply UGyraBrightnessEditor::NativeOnMouseWheel(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
...
void UGyraBrightnessEditor::HandleInputModeChanged(ECommonInputType InInputType)
{
...
void UGyraBrightnessEditor::HandleBackClicked()
{
	DeactivateWidget();
	SSafeZone::SetGlobalSafeZoneScale(UGyraSettingsLocal::Get()->GetSafeZone());
}

void UGyraBrightnessEditor::HandleDoneClicked()
{
