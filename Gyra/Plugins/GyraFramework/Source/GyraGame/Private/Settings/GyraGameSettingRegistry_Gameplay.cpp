...
UGameSettingCollection* UGyraGameSettingRegistry::InitializeGameplaySettings(UGyraLocalPlayer* InLocalPlayer)
{
...

	{
		...
		//----------------------------------------------------------------------------------
		{
			UGyraSettingValueDiscrete_Language* Setting = NewObject<UGyraSettingValueDiscrete_Language>();
