...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GyraTeamCheats)

//////////////////////////////////////////////////////////////////////
// UGyraTeamCheats

void UGyraTeamCheats::CycleTeam()
{
...
void UGyraTeamCheats::SetTeam(int32 TeamID)
{
	if (UGyraTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UGyraTeamSubsystem>(GetWorld()))
	{
...
void UGyraTeamCheats::ListTeams()
{
	if (UGyraTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UGyraTeamSubsystem>(GetWorld()))
	{
		const TArray<int32> TeamIDs = TeamSubsystem->GetTeamIDs();
