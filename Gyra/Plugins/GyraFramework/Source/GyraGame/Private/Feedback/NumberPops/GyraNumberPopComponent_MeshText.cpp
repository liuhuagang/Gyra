...
#include "GyraNumberPopComponent_MeshText.h"
...
#include "GyraDamagePopStyle.h"
#include "Materials/MaterialInstanceDynamic.h"
#include "TimerManager.h"
#include "UObject/Package.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GyraNumberPopComponent_MeshText)

class UStaticMesh;

UGyraNumberPopComponent_MeshText::UGyraNumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void UGyraNumberPopComponent_MeshText::AddNumberPop(const FGyraNumberPopRequest& NewRequest)
{
...
void UGyraNumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor UGyraNumberPopComponent_MeshText::DetermineColor(const FGyraNumberPopRequest& Request) const
{
	for (UGyraDamagePopStyle* Style : Styles)
	{
...
UStaticMesh* UGyraNumberPopComponent_MeshText::DetermineStaticMesh(const FGyraNumberPopRequest& Request) const
{
	for (UGyraDamagePopStyle* Style : Styles)
	{
...
void UGyraNumberPopComponent_MeshText::SetMaterialParameters(const FGyraNumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
