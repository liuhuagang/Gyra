...
#include "GyraBoundActionButton.h"

#include "CommonInputSubsystem.h"
#include "CommonInputTypeEnum.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GyraBoundActionButton)

class UCommonButtonStyle;

void UGyraBoundActionButton::NativeConstruct()
{
...
void UGyraBoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
