...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UGyraIndicatorManagerComponent* InManager)
{
...
{
	if (UGyraIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
