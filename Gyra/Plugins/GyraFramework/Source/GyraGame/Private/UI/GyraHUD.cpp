...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GyraHUD)
...
AGyraHUD::AGyraHUD(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	PrimaryActorTick.bStartWithTickEnabled = false;
}

void AGyraHUD::PreInitializeComponents()
{
...
void AGyraHUD::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void AGyraHUD::GetDebugActorList(TArray<AActor*>& InOutList)
{
