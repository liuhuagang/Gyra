...
#include "GyraCosmeticAnimationTypes.generated.h"
...
struct FGyraAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FGyraAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FGyraAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FGyraAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FGyraAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FGyraAnimBodyStyleSelectionEntry> MeshRules;
