...
#include "GyraPerformanceStatSubsystem.generated.h"
...
struct FGyraPerformanceStatCache : public IPerformanceDataConsumer
{
public:
	FGyraPerformanceStatCache(UGyraPerformanceStatSubsystem* InSubsystem)
	...
	double GetCachedStat(EGyraDisplayablePerformanceStat Stat) const;

protected:
	IPerformanceDataConsumer::FFrameData CachedData;
	UGyraPerformanceStatSubsystem* MySubsystem;
...
class UGyraPerformanceStatSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
protected:
	TSharedPtr<FGyraPerformanceStatCache> Tracker;
};
