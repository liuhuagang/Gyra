...
#include "GyraSimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="Gyra Simulated Input Widget" ))
class GYRAGAME_API UGyraSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UGyraSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
