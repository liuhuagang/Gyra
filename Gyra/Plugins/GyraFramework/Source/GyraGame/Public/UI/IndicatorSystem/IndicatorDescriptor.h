...
class GYRAGAME_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UGyraIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UGyraIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UGyraIndicatorManagerComponent> ManagerPtr;
