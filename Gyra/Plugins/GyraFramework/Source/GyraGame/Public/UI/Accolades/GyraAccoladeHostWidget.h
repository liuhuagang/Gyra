...
#include "Accolades/GyraAccoladeDefinition.h"
#include "AsyncMixin.h"
#include "CommonUserWidget.h"
#include "GameFramework/GameplayMessageSubsystem.h"

#include "GyraAccoladeHostWidget.generated.h"

class UObject;
class USoundBase;
class UUserWidget;
struct FDataRegistryAcquireResult;
struct FGyraNotificationMessage;
...
struct FPendingAccoladeEntry
{
	...
	FGyraAccoladeDefinitionRow Row; 
...
class UGyraAccoladeHostWidget : public UCommonUserWidget, public FAsyncMixin
{
	GENERATED_BODY()
...
private:
	...
	void OnNotificationMessage(FGameplayTag Channel, const FGyraNotificationMessage& Notification);
