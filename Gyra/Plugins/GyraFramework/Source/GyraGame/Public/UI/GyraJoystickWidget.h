...
#include "GyraJoystickWidget.generated.h"
...
/**
 *  A UMG wrapper for the Gyra virtual joystick.
 *
 ...
 */
UCLASS(meta=( DisplayName="Gyra Joystick" ))
class GYRAGAME_API UGyraJoystickWidget : public UGyraSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UGyraJoystickWidget(const FObjectInitializer& ObjectInitializer);
