...
#include "GyraCheatManager.generated.h"
...
DECLARE_LOG_CATEGORY_EXTERN(LogGyraGameCheat, Log, All);
...
class UGyraCheatManager : public UCheatManager
{
	GENERATED_BODY()
...
protected:
	...
	void ApplySetByCallerDamage(UGyraAbilitySystemComponent* GyraASC, float DamageAmount);
	void ApplySetByCallerHeal(UGyraAbilitySystemComponent* GyraASC, float HealAmount);

	UGyraAbilitySystemComponent* GetPlayerAbilitySystemComponent() const;
};
