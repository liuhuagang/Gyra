...
#include "GyraAudioSettings.generated.h"
...
USTRUCT()
struct GYRAGAME_API FGyraSubmixEffectChainMap
{
	GENERATED_BODY()
 ...
 * 
 */
UCLASS(config = Game, defaultconfig, meta = (DisplayName = "GyraAudioSettings"))
class GYRAGAME_API UGyraAudioSettings : public UDeveloperSettings
{
	GENERATED_BODY()
...
public:
	...
	TArray<FGyraSubmixEffectChainMap> HDRAudioSubmixEffectChain;
	
	/** Submix Processing Chains to achieve low dynamic range audio output */
	UPROPERTY(config, EditAnywhere, Category = EffectSettings)
	TArray<FGyraSubmixEffectChainMap> LDRAudioSubmixEffectChain;
