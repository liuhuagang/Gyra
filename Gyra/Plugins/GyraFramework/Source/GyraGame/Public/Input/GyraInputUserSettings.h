...
#include "GyraInputUserSettings.generated.h"

/** 
 * Custom settings class for any input related settings for the Gyra game.
 * This will be serialized out at the same time as the Gyra Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS()
class GYRAGAME_API UGyraInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class GYRAGAME_API UGyraPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
