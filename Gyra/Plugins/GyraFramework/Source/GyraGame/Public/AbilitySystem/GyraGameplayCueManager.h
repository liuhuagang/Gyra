...
#include "GyraGameplayCueManager.generated.h"
...
/**
 * UGyraGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UGyraGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:

	UGyraGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UGyraGameplayCueManager* Get();
