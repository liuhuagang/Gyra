...
#include "GyraGamePhaseAbility.generated.h"

/**
 * UGyraGamePhaseAbility
 *
 * The base gameplay ability for any ability that is used to change the active game phase.
 */
UCLASS(Abstract, HideCategories = Input)
class UGyraGamePhaseAbility : public UGyraGameplayAbility
{
	GENERATED_BODY()

public:

	UGyraGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Gyra|Game Phase")
