...
#include "GyraSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UGyraSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()

public:

	UGyraSettingValueDiscrete_Resolution();
