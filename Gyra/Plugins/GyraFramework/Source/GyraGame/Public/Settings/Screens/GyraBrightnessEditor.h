...
#include "GyraBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class UGyraBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UGyraBrightnessEditor(const FObjectInitializer& Initializer);
