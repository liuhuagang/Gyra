...
#include "GyraSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UGyraSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UGyraSafeZoneEditor(const FObjectInitializer& Initializer);
