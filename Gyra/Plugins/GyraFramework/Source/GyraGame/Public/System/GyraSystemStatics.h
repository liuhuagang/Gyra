...
#include "GyraSystemStatics.generated.h"
...
UCLASS()
class UGyraSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "Gyra", meta = (WorldContext = "WorldContextObject"))
