...
#include "GyraPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FGyraPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FGyraPenetrationAvoidanceFeeler()
	...
	FGyraPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
