...
#include "GyraPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "GyraCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UGyraCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UGyraCameraMode_ThirdPerson : public UGyraCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FGyraPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
