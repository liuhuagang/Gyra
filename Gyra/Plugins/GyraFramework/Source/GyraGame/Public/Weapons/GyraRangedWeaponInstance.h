...
#include "GyraRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UGyraRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 * 一件装备代表一个远程武器产生和应用于兵
 */
UCLASS()
class UGyraRangedWeaponInstance : public UGyraWeaponInstance, public IGyraAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UGyraRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
