...
#include "GyraWeaponInstance.generated.h"
 ...
 */
UCLASS()
class UGyraWeaponInstance : public UGyraEquipmentInstance
{
	GENERATED_BODY()

public:
	UGyraWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	FGyraAnimLayerSelectionSet EquippedAnimSet;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Animation)
	FGyraAnimLayerSelectionSet UneuippedAnimSet;
