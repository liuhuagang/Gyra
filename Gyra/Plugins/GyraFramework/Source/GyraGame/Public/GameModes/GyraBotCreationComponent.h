...
#include "GyraBotCreationComponent.generated.h"
...
class UGyraBotCreationComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	UGyraBotCreationComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
