...
#include "GyraGameMode.generated.h"
 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnGyraGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class AGyraGameMode : public AModularGameModeBase
{
	GENERATED_BODY()

public:

	AGyraGameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "Gyra|Pawn")
	const UGyraPawnData* GetPawnDataForController(const AController* InController) const;
	...
	FOnGyraGameModePlayerInitialized OnGameModePlayerInitialized;
